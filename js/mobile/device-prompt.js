...
(function() {
    function showPrompt() {
        ...
        title.style.cssText = "font-family:'Silkscreen',monospace;font-size:16px;color:#3F3F3F;text-align:center;margin-bottom:8px;";
        box.appendChild(title);

        var btnM = document.createElement('button');
        btnM.textContent = 'Mobile / Touchscreen';
        btnM.style.cssText = 'width:100%;height:40px;font-size:14px;font-family:"Silkscreen",monospace;background:#999;border:2px solid #000;box-shadow:inset 2px 2px 0 #ccc,inset -2px -2px 0 #555;color:#fff;text-shadow:1px 1px 0 #333;cursor:pointer;';

        var btnD = document.createElement('button');
        btnD.textContent = 'Desktop / Keyboard & Mouse';
        btnD.style.cssText = 'width:100%;height:40px;font-size:14px;font-family:"Silkscreen",monospace;background:#999;border:2px solid #000;box-shadow:inset 2px 2px 0 #ccc,inset -2px -2px 0 #555;color:#fff;text-shadow:1px 1px 0 #333;cursor:pointer;';
