...
window.spawnDroppedItem = function(x, y, z, id, count = 1, customVx = null, customVy = null, customVz = null) {
    ...
    const isMaterial = (id >= 112 && id <= 123) || id === 128 || id === 129 || id === 134 || id === 135 || id === 137 || id === 142 || id === 143 || id === 151 || id === 260 || id === 261
                    || id === 197 || id === 198 || id === 199
                    || id === 23 || id === 53 || id === 24 || id === 26 || id === 116 || id === 117 || id === 118 || id === 221 || id === 222 || id === 17;
    const isFlatBlock = (id === 66 || id === 67);
    const isToolItem = (id >= 100 && typeof TOOL_DATA !== 'undefined' && TOOL_DATA[id]);
    const forceCubeBlock = (typeof isMesaBlock === 'function' && isMesaBlock(id));
    const is2D = !forceCubeBlock && (isMaterial || isFlatBlock || isToolItem);
